...
switch(mes){
    case "Enero": case "enero": case "Febrero": case "Febrero":
    case "Marzo": case "marzo":  
    case "Mayo": case "mayo": 
    case "Julio": case "julio": case "Agosto": case "agosto": 
    case "Octubre": case "octubre": 
    case "Diciembre": case "diciembre":
        diasdelmes = 31;
        break;
    case "Abril": case "abril": case "Junio": case "junio":
    case "Septiembre": case "septiembre": case "Noviembre": case "noviembre":
        diasdelmes = 30;
        break;
...
if(bisiesto == true){
    var msg = "El año " + year + " es bisiesto.<br />El mes de " + mes + " tiene " + diasdelmes + " días.";
        ...
        var msg = "El año " + year + " no es bisiesto.<br />El mes de " + mes + " tiene " + diasdelmes + " días.";
            ...
            //donde se mostrará el número de años, meses y días que ha vivido la persona
